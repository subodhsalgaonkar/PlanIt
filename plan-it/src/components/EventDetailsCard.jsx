...
// import eventbackground from "../assets/eventbackground.jpg";
...
const EventDetailsCard = ({ event, onClose }) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 bg-fixed ">
      <div className="relative p-8 rounded-lg shadow-lg w-full max-w-md max-h-60 overflow-y-auto bg-blue-300" >
        <button
