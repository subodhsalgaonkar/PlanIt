...
import EventDetailsCard from "./EventDetailsCard"; // Import the new component
  ...
  return (
    <EventsProvider value={{ events, setEvents }}>
      <div className="relative">
        ...
        <CalendarHeader handleLogout={handleLogout} />
        <SideBar />
        {isLoggedIn && (
          <Calendar
            localizer={localizer}
        ...
        {selectedEvent && (
          <EventDetailsCard event={selectedEvent} onClose={handleCloseDetailsCard} />
        )}
      </div>
    </EventsProvider>
  );
